...
- Name: dashboard.spec.ts >> EMBER Dashboard >> Risk Gauge >> renders risk card with gauge
- Location: tests\e2e\dashboard.spec.ts:23:5
...
Call log:
  ...
  - waiting for getByTestId('risk-card')
