...
- Name: dashboard.spec.ts >> EMBER Dashboard >> Alert Panel >> shows correct alert count badge
- Location: tests\e2e\dashboard.spec.ts:50:5
...
Locator: getByTestId('alert-count')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('alert-count')
