...
- Name: dashboard.spec.ts >> EMBER Dashboard >> Risk Gauge >> risk caption is displayed
- Location: tests\e2e\dashboard.spec.ts:37:5
...
Call log:
  ...
  - waiting for locator('.risk-caption')
