...
- Name: dashboard.spec.ts >> EMBER Dashboard >> Biometric Chart >> riskScore tab is active by default
- Location: tests\e2e\dashboard.spec.ts:101:5
...
Locator: getByTestId('tab-riskScore')
...
Call log:
  ...
  - waiting for getByTestId('tab-riskScore')
