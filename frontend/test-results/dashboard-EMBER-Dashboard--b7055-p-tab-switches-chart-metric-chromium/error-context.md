...
- Name: dashboard.spec.ts >> EMBER Dashboard >> Biometric Chart >> clicking Sleep tab switches chart metric
- Location: tests\e2e\dashboard.spec.ts:113:5
...
Call log:
  - waiting for getByTestId('tab-sleep')
...
- generic [ref=e3]:
  - banner [ref=e4]:
    - generic [ref=e7]: EMBER
    - button "Refresh data" [ref=e9]:
      - img [ref=e10]
  - main [ref=e15]:
    - generic [ref=e16]:
      - generic [ref=e17]: ⚠ Failed to fetch
      - button "Retry" [ref=e18]
```
