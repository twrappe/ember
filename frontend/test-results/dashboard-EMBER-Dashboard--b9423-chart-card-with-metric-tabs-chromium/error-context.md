...
- Name: dashboard.spec.ts >> EMBER Dashboard >> Biometric Chart >> renders chart card with metric tabs
- Location: tests\e2e\dashboard.spec.ts:89:5
...
Locator: getByTestId('chart-card')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('chart-card')
