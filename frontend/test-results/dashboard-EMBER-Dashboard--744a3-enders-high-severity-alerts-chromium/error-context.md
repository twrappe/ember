...
- Name: dashboard.spec.ts >> EMBER Dashboard >> Alert Panel >> renders high severity alerts
- Location: tests\e2e\dashboard.spec.ts:57:5
...
Locator: locator('[data-severity="high"]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-severity="high"]').first()
