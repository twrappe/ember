...
- Name: dashboard.spec.ts >> EMBER Dashboard >> Biometric Chart >> chart renders recharts SVG
- Location: tests\e2e\dashboard.spec.ts:118:5
...
Locator: locator('.recharts-responsive-container')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.recharts-responsive-container')
