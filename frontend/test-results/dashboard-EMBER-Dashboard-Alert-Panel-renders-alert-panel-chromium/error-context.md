...
- Name: dashboard.spec.ts >> EMBER Dashboard >> Alert Panel >> renders alert panel
- Location: tests\e2e\dashboard.spec.ts:46:5
...
Locator: getByTestId('alert-panel')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('alert-panel')
